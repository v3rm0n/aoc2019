...
class Advent7Test {
    ...
    @Test
    fun `amplifier with feedback works - 1`() {
        assertEquals(
            139629729,
    ...
    @Test
    fun `amplifier with feedback works - 2`() {
        assertEquals(
            18216,
